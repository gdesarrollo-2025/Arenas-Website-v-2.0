...
export default function FavoriteButton({ p }: { p: Property  }) {
    ...
    return <button className="absolute z-10 h-8 aspect-square rounded-full right-3 top-3 bg-background/50 p-1" type="button" onClick={() => isFavorite ? removeFavorite(p) : addFavorite(p)}>
